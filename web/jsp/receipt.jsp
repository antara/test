...
<tr id="tabletr">
	...
	<td align="left" colspan="3"><div align="left" style="margin-left:20px"> &nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;
        ...
        <s:button name="inPrint" id="inPrint" onClick="return callPrint();">Print</s:button>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 <s:button name="inClose" id="inClose" onClick="javascript: window.close();">Close</s:button>
	  </div></td>
